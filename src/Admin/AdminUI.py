...
class Admin(ttk.Frame):
    def __init__(self, parent, controller, path):
        ...
        self.inventoryFrame = tk.LabelFrame(self.configFrame, text="Inventario")
        self.inventoryFrame.pack(fill=tk.BOTH, expand=True, padx=30, pady=(20, 10))

        row1Frame1 = tk.Frame(self.inventoryFrame)
        row1Frame1.pack(fill=tk.BOTH, expand=True)

        self.areaLabel = tk.Label(row1Frame1, text="Area :", font="Arial 14")
        self.areaLabel.pack(side="left", fill="x", expand=True)
        self.areaEntry = tk.Entry(row1Frame1, font="Arial 14", justify="center")
        ...
        self.estacionLabel = tk.Label(row2Frame1, text="Estacion :", font="Arial 14")
        self.estacionLabel.pack(side="left", fill="x", expand=True)
        self.estacionEntry = tk.Entry(row2Frame1, font="Arial 14", justify="center")
        self.estacionEntry.pack(side="left", fill="x", expand=True, padx=(10, 60))
        ...
        self.redFrame = tk.LabelFrame(self.configFrame, text="Red")
        ...
        self.ipLabel = tk.Label(row1Frame2, text="Direccion IP :", font="Arial 14")
        self.ipLabel.pack(side="left", fill="x", expand=True)
        self.ipEntry = tk.Entry(row1Frame2, font="Arial 14", justify="center")
        ...
        self.databaseEntry = tk.Entry(row2Frame2, font="Arial 14", justify="center")
        self.databaseEntry.pack(side="left", fill="x", expand=True, padx=(10, 60))

        self.redButton = tk.Button(
            self.redFrame, text="Guardar", font="Arial 14", command=self.saveRedOptions
        )
        ...
        self.label = tk.Label(self.addDataFrame, text="Subir Wip", font="Arial 40")
        # font=controller.title_font)
        self.label.grid(row=0, column=0, columnspan=6, pady=(20, 30), padx=(10, 0))

        self.directory = ttk.Label(self.addDataFrame, font=customFont, **cn.labelConf)
        self.directory.grid(
        ...
        self.monthLabel = tk.Label(self.addDataFrame, text="Mes", font="Arial 20")
        self.monthLabel.grid(row=4, column=0, columnspan=1)
        self.monthEntry = tk.Entry(self.addDataFrame, justify="center", font="Arial 20")
        self.monthEntry.grid(row=4, column=1, sticky="NS")

        self.yearLabel = tk.Label(self.addDataFrame, text="Año", font="Arial 20")
        self.yearLabel.grid(row=4, column=2, columnspan=1)
        self.yearEntry = tk.Entry(self.addDataFrame, justify="center", font="Arial 20")
        ...
        self.button1.grid(row=4, column=4, columnspan=2, sticky="EW", padx=(40, 10))
        ...
        # font=controller.title_font)
        self.deleteLabel.grid(
            row=0, column=0, columnspan=6, pady=(20, 30), padx=(10, 0)
        )
        ...
        self.deleteButton.grid(
            row=4, column=4, columnspan=2, sticky="EW", padx=(40, 10)
        )
    ...
    def uploadData(self):
        ...
        if exist and date != "" and self.filename != "":
            self.wipStatusLabel.config(text="Ya existen datos en la fecha.", fg="red")
            return
        ...
        if self.filename == "":
            ...
            return
        if month == "":
            self.wipStatusLabel.config(text="Debes introducir el mes.", fg="red")
            return
        if year == "":
            self.wipStatusLabel.config(text="Debes introducir el año.", fg="red")
            return
